...
1. With renewed authorization, repair the disposable offline-cache preparation and run one complete matrix from frozen implementation `2cbc319`. The previous run stopped as recorded above; do not deploy based only on focused results.
